 ...
 * @status_stats.lost_agg_packets: # of lost aggregated packets
 * @status_stats.last_agg_pkt_time: timestamp of last ACKed packet
...
struct link_sta_info {
	...
	struct {
		...
		unsigned int lost_agg_packets;
		unsigned long last_agg_pkt_time;
